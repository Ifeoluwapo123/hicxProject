...
public class DirectoryObserver {
    ...
    public void initializeWatcher(Path path){
    ...
    public void createProcessedDir(Path path){
        ...
        processedDir = path.resolve("processedDir");
    ...
    private void processFile(FILETYPES filetype, FileProcessorFactory fileProcessorFactory, Path fileName, Path path){
        ...
        // move file
        fileProcessor.moveFile(path.resolve(fileName), Path.of(processedDir+"/"+fileName));
